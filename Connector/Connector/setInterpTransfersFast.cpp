...
void K_CONNECTOR::setInterpTransfersFast(
  ...
  E_Int& nstep        , E_Int& nitmax          , E_Int& rk           , E_Int& exploc           , E_Int& numpassage, E_Int*& grp2transfer)
...
*/
     ...
     if (mpi )
    {
      ...
      //
      getTransfersInter(nbcomIBC_S, iptro_tmp, param_int, param_int_tc , pair_of_queue_IBC, grp2transfer);
...
/*        cout << "Intra com " << dest << "\n";*/
    ...
    if (mpi)
    {
       ...
       getTransfersInter(nbcomID, iptro_tmp, param_int, param_int_tc , pair_of_queue, grp2transfer);
...
void K_CONNECTOR::setInterpTransfersIntra(
    ...
    E_Float*& ipt_timecount, E_Int& nstep, E_Int& nssiter, E_Int& rk, E_Int& exploc, E_Int& num_passage, E_Int*& grp2transfer)
{
	 ...
	 if (autorisation_transferts[pass_inst][irac_auto]==1)
	  {
          ...
          if (varType == 112){nvars_loc = nvars;}
...
void K_CONNECTOR::setInterpTransfersInter(
    ...
    E_Int& nstep, E_Int& nssiter, E_Int& rk, E_Int& exploc, E_Int& num_passage, E_Int& nb_send_buffer, E_Int*& grp2transfer)
...
/*                     E_Int overset  =  param_int[NoD][LBM_OVERSET];        //flag pour overset en LBM
                     ...
                     E_Int* ptrcnd  = NULL;
                      ...
                      /*printf("navr_loc nvars NoD  ipass_typ %d %d %d %d \n\n", nvars_loc, nvars, NoD,ipass_typ);
*/
/*                     if (nvars_loc == 5 || nvars_loc == 6) // Transferts NS classiques ou LBM -> NS
                     {*/
