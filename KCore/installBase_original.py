...
['/usr/include', '/usr/include/x86_64-linux-gnu/', '/usr/include/mpi', '/usr/include/hdf5/serial'], # additionalIncludePaths
...
###############################################################################
'pa-dyf-dyakov': [ 'Alferez Workstation (ubuntu)',
'ifort', # f77compiler
'ifort', # f90compiler
'icpc', # Cppcompiler
[], # CppAdditionalOptions
...
False, # static
False, # CPlotOffScreen
['/usr/include/hdf5/serial'],#['/usr/include/mpi', '/usr/include/hdf5/serial'], # additionalIncludePaths
['gfortran', 'gomp', 'pthread'], # additionalLibs
['/usr/lib/x86_64-linux-gnu','/usr/lib/x86_64-linux-gnu/hdf5/serial/'], # additionalLibPaths
False, # useCuda
[] # NvccAdditionalOptions
